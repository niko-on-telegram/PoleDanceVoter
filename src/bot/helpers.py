...
async def print_constestant_list(message: Message, db_session: AsyncSession):
    main_message = """Идёт подсчёт голосов перед финальным этапом голосования!
⚡️ Совсем скоро станет известно, кто продолжит борьбу за победу в проекте.
    
Спасибо за вашу активность и поддержку! 🙌✨"""
